...
print(f"╚═╦══════════════════════════════════════════════════════════════════╝")
print(f"  ║ Exactly {k} Endereyes ≈ {bdf_exact(n, k, p):.3f}% of EPs")
print(f"  ║ Minimum {k} Endereyes ≈ {bdf_min(n, k, p):.3f}% of EPs")
print(f"  ║ Maximum {k} Endereyes ≈ {bdf_max(n, k, p):.3f}% of EPs")
print(f"  ║ More than {k} Endereyes ≈ {bdf_morethan(n, k, p):.3f}% of EPs")
print(f"  ║ Less than {k} Endereyes ≈ {bdf_lessthen(n, k, p):.3f}% of EPs")
print(f"  ╚══════════════════════════════════════════════════════════════════╝")